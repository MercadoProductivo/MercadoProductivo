...
// Exponer el estado del flag para diagnósticos/espera explícita desde componentes
export function isPusherFeatureEnabled(): boolean {
  return featureEnabled;
}

export async function ensurePusherFeatureReady(): Promise<boolean> {
  try {
    if (!featureChecked) {
