...
export async function GET() {
  try {
    ...
    if (!url || !serviceKey) {
      logger.error("Missing Supabase environment variables for public/plans", { hasUrl: !!url, hasServiceKey: !!serviceKey });
    ...
    if (error) {
      ...
      logger.error("Failed to fetch plans with full columns", {
