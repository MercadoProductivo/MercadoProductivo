        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          ...
          <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
            ...
            <p className="mt-2 text-muted-foreground">
              Sube y gestiona tus productos con imágenes y descripciones detalladas.
            </p>
          </div>
          ...
          <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg font-medium">Destaca tus Productos</h3>
            <p className="mt-2 text-muted-foreground">
              Haz que tus productos se vean primero con nuestros créditos de destacados.
            </p>
          </div>
          ...
          <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg font-medium">Chat Integrado</h3>
            <p className="mt-2 text-muted-foreground">
              Conecta con tus clientes en tiempo real mediante nuestro chat integrado.
            </p>
          </div>
        </div>
      </section>
